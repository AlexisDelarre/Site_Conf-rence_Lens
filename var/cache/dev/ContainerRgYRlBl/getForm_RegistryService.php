...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\ConferenceType' => function () {
    return ($this->privates['App\Form\ConferenceType'] ?? $this->load(__DIR__.'/getConferenceTypeService.php'));
}, 'App\\Form\\ContentType' => function () {
    return ($this->privates['App\Form\ContentType'] ?? $this->load(__DIR__.'/getContentTypeService.php'));
}, 'App\\Form\\HomepageType' => function () {
    return ($this->privates['App\Form\HomepageType'] ?? $this->load(__DIR__.'/getHomepageTypeService.php'));
