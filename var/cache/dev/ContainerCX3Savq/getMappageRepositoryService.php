...
// Returns the private 'App\Repository\MappageRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MappageRepository.php';

return $this->privates['App\Repository\MappageRepository'] = new \App\Repository\MappageRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
