...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->fileMap = array(
            'App\\Controller\\ConferenceController' => __DIR__.'/getConferenceControllerService.php',
            'App\\Controller\\HomepageController' => __DIR__.'/getHomepageControllerService.php',
            'App\\Controller\\SecurityController' => __DIR__.'/getSecurityControllerService.php',
            'App\\Entity\\Conference' => __DIR__.'/getConferenceService.php',
            'App\\Entity\\Homepage' => __DIR__.'/getHomepageService.php',
            'App\\Event\\ConferenceEvent' => __DIR__.'/getConferenceEventService.php',
            'App\\Event\\HomepageEvent' => __DIR__.'/getHomepageEventService.php',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('conference_add', array(0 => function () {
            return ($this->privates['App\EventListerner\ConferenceSubscriber'] ?? $this->load(__DIR__.'/getConferenceSubscriberService.php'));
        }, 1 => 'add'), 0);
        $instance->addListener('conference_delete', array(0 => function () {
            return ($this->privates['App\EventListerner\ConferenceSubscriber'] ?? $this->load(__DIR__.'/getConferenceSubscriberService.php'));
        }, 1 => 'remove'), 0);
        $instance->addListener('conference_edit', array(0 => function () {
            return ($this->privates['App\EventListerner\ConferenceSubscriber'] ?? $this->load(__DIR__.'/getConferenceSubscriberService.php'));
        }, 1 => 'edit'), 0);
        $instance->addListener('homepage_add', array(0 => function () {
            return ($this->privates['App\EventListerner\HomepageSubscriber'] ?? $this->load(__DIR__.'/getHomepageSubscriberService.php'));
        }, 1 => 'add'), 0);
        $instance->addListener('homepage_edit', array(0 => function () {
            return ($this->privates['App\EventListerner\HomepageSubscriber'] ?? $this->load(__DIR__.'/getHomepageSubscriberService.php'));
        }, 1 => 'edit'), 0);
