...
$a->setNamespace('sf_orm_default_ca4c60ac312f4fea4b3c832de3ef8a81e2e11557eb3b21538dea33c4b85dfc14');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_ca4c60ac312f4fea4b3c832de3ef8a81e2e11557eb3b21538dea33c4b85dfc14');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_ca4c60ac312f4fea4b3c832de3ef8a81e2e11557eb3b21538dea33c4b85dfc14');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\ConferenceRepository' => function () {
    return ($this->privates['App\Repository\ConferenceRepository'] ?? $this->load(__DIR__.'/getConferenceRepositoryService.php'));
}, 'App\\Repository\\HomepageRepository' => function () {
    return ($this->privates['App\Repository\HomepageRepository'] ?? $this->load(__DIR__.'/getHomepageRepositoryService.php'));
}, 'App\\Repository\\MappageRepository' => function () {
    return ($this->privates['App\Repository\MappageRepository'] ?? $this->load(__DIR__.'/getMappageRepositoryService.php'));
